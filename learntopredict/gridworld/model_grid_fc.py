...
class SimpleWorldModel:
  ...
  def __init__(self, obs_size=49*4, action_size=4, hidden_size=80):
    ...
    if self.hard_reward:
      ...
      self.shapes = [ (50 + self.action_size, self.hidden_size), #was 5, 9, 50
                        (self.hidden_size, 50)] #was 1, 1, 50
...
class CustomModel:
  ...
  def get_action(self, prev_obs, t=0, mean_mode=False):
    ...
    next_apples, next_fires = self.world_model.deterministic_predict_next_state(obs, self.prev_action)
